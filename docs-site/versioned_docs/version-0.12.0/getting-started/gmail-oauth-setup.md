...
description: Step-by-step Google Cloud setup for ify app Gmail tracking, with exact scopes and callback configuration.
sidebar_position: 2
---

## What it is

This guide configures Google OAuth so ify app can read recruitment emails from Gmail for the Tracking Inbox.

## Why it exists

Gmail OAuth setup is easy to misconfigure (wrong redirect URI, missing refresh token, or unnecessary scopes). This page documents the exact defaults ify app expects.
...
- ify app does not require JavaScript origins for this flow.
...
### 3) Connect Gmail in ify app

1. Open **Tracking Inbox**.
2. Click **Connect Gmail**.
3. Complete Google consent.

ify app starts OAuth with:
...
Not required for ify app Gmail ingestion:
