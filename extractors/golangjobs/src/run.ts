import { normalizeCountryKey } from "ify-app-shared/location-support";
import {
  matchesRequestedCity,
  normalizeLocationToken,
  resolveSearchCities,
} from "ify-app-shared/search-cities";
import type { CreateJobInput } from "ify-app-shared/types/jobs";
