...
import { SocialMediaSettingsSection } from "@client/pages/settings/components/SocialMediaSettingsSection";
    ...
    items: [
      {
        id: "social-media",
        label: "Social Media",
        description: "Connect LinkedIn and Instagram for auto-posting.",
        searchTerms: ["linkedin", "instagram", "social", "share", "post"],
      },
    ],
  },
  {
...
export const SettingsPage: React.FC = () => {
        ...
        if (!precheckFailure) {
          ...
          if (isRxResumeAvailabilityValidationFailure(validation)) {
            rxResumeSaveWarningMessage =
              "Settings saved, but ify app could not verify Reactive Resume because the instance is unavailable.";
          }
        }
      }
  ...
  switch (activeSection) {
    ...
    case "tracer-links":
      ...
      break;
    case "social-media":
      activeSectionContent = <SocialMediaSettingsSection />;
      break;
    case "environment":
      activeSectionContent = (
