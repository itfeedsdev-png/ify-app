...
export const OnboardingPage: React.FC = () => {
  ...
  if (bootstrapState === "error") {
    return (
      <LoadingState message="ify app could not check the workspace setup. Refresh the page to try again." />
    );
  }
  if (bootstrapState === "account") {
...
function LoadingState({ message }: { message: string }) {
  return (
    <>
      <PageHeader icon={Sparkles} title="Set up ify app" subtitle={message} />
      <PageMain>
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="This private account owns your ify app workspace."
      />
      <PageMain>
            ...
            <CardContent className="p-6 sm:p-8">
              {activeStep === "profile" ? (
                ...
                <StepShell
                  ...
                  title="Choose how ify app should think"
                  description="Pick a provider first. ify app saves the configuration only after the server verifies the connection."
                >
                  <LlmConnectionStep
...
function ProfileStep(props: {
  ...
  return (
    <StepShell
      ...
      description="These preferences seed new runs and help ify app prioritize location-aware and visa-sponsor sources. You can change them later."
    >
      ...
      >
        ...
        <span>
          ...
          <span className="block text-sm text-muted-foreground">
            ify app will show sponsor information and favor sponsor-aware
...
function ResumeStep({
  ...
  if (!hasResume) {
    return (
      <StepShell
        eyebrow="Your resume"
        title="Load the resume ify app should use"
