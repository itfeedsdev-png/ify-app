...
describe("server product analytics", () => {
  ...
  const originalBaseUrl = process.env.IFYAPP_PUBLIC_BASE_URL;
  ...
  beforeEach(() => {
    ...
    process.env.IFYAPP_PUBLIC_BASE_URL = "https://jobops.example";
  ...
  afterEach(() => {
    ...
    if (originalBaseUrl === undefined) {
      ...
      process.env.IFYAPP_PUBLIC_BASE_URL = originalBaseUrl;
    }
