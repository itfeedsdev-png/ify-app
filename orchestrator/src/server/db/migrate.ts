...
const DEFAULT_TENANT_NAME = "ify app";
...
if (!tableExists("social_connections")) {
  sqlite.exec(`
  ...
  `);
  sqlite.exec(
    "CREATE UNIQUE INDEX idx_social_connections_tenant_user_platform_unique ON social_connections(tenant_id, user_id, platform)",
  );
}
