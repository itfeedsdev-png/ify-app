...
const IFYAPP_UMAMI_SCRIPT_SELECTOR = 'script[data-ifyapp-umami="docs"]';
...
export function ensureDocsUmamiScript(args: {
  ...
  if (args.document.querySelector(IFYAPP_UMAMI_SCRIPT_SELECTOR)) return;
  ...
  script.setAttribute("data-ifyapp-umami", "docs");
