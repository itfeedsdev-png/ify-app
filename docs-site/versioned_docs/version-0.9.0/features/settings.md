...
- If language detection is unclear or there is not enough resume/profile text, ify app falls back to English
...
- If ify app cannot determine a reliable resume/profile language, it safely uses English.
