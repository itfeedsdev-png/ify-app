...
2. **Set up environment:**
   ...
   You can edit the confirmed document later in **Resume Studio**. ify app uses that document as the primary context for tailoring, scoring, and PDF generation.
