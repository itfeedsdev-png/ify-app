...
- In Map radius mode, ify app expands the selected circle into named cities and towns, searches each place through JobSpy, and centrally filters the returned locations. The configured result allowance is shared across those place searches.
