 ...
 * which ify app uses when LLM_PROVIDER is `gemini_cli`.
 */
  ...
  return (
    <div className="rounded-lg border border-dashed border-border/60 bg-muted/20 px-4 py-3 text-sm text-muted-foreground">
      ...
      <p className="mt-2">
        ...
        the CLI. ify app spawns the CLI in headless mode and reuses those
        credentials — no ify app API key field.
      </p>
      <p className="mt-2">
        <a
