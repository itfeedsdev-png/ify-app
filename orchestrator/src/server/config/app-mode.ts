...
const APP_MODE_ENV_KEY = "IFYAPP_APP_MODE";
const HOSTED_TENANT_ID_ENV_KEY = "IFYAPP_HOSTED_TENANT_ID";
const HOSTED_SIGNUPS_ENV_KEY = "IFYAPP_HOSTED_SIGNUPS_ENABLED";
const HOSTED_PLATFORM_LLM_ENV_KEY = "IFYAPP_HOSTED_PLATFORM_LLM_ENABLED";
const HOSTED_QUOTAS_ENV_KEY = "IFYAPP_HOSTED_QUOTAS_ENABLED";
