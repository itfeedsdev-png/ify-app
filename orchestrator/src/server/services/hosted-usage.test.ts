...
describe.sequential("hosted usage service", () => {
  ...
  beforeEach(async () => {
    ...
    delete process.env.IFYAPP_APP_MODE;
    delete process.env.IFYAPP_HOSTED_QUOTAS_ENABLED;
    delete process.env.IFYAPP_HOSTED_SIGNUPS_ENABLED;
    delete process.env.IFYAPP_HOSTED_TENANT_ID;
  ...
  function enableHostedQuotas(): void {
    process.env.IFYAPP_APP_MODE = "hosted";
    process.env.IFYAPP_HOSTED_TENANT_ID = "tenant_default";
    process.env.IFYAPP_HOSTED_QUOTAS_ENABLED = "true";
  }
  ...
  it("returns no-op allowance and writes no rows when hosted quotas are disabled", async () => {
    process.env.IFYAPP_APP_MODE = "hosted";
    process.env.IFYAPP_HOSTED_TENANT_ID = "tenant_default";
    process.env.IFYAPP_HOSTED_QUOTAS_ENABLED = "false";
    const service = await import("./hosted-usage");
