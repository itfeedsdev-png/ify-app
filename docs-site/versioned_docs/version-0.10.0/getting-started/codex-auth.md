...
description: Authenticate Codex in ify app with the built-in device-code sign-in flow.
sidebar_position: 3
---

## What it is

This page explains how to authenticate the `codex` provider in ify app.

Use the device-code sign-in flow from the ify app UI.
...
### Device-code sign-in in ify app

1. In ify app, set **Provider** to `Codex` in onboarding or settings.
