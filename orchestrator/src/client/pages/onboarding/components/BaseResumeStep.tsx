...
export const BaseResumeStep: React.FC<{
  ...
  const uploadDescription = allowReactiveResume
    ? "ify app imports Reactive Resume JSON directly. PDF and DOCX files are sent to your configured AI model and stored as a local Design Resume. That resume drives job matching, fit assessment, search terms, and application workflows."
    : "Upload your existing resume as a PDF or DOCX. ify app will import it and use it as the baseline for matching, fit assessment, search terms, and application workflows.";
          ...
          {[
            {
              ...
              title: "Upload a file",
              description:
                "Turn a PDF, DOCX, or Reactive Resume JSON into the baseline ify app uses for matching and tailoring.",
            },
            {
              value: "rxresume",
              title: "Use Reactive Resume",
              description:
                "Connect an existing Reactive Resume so ify app can assess fit and build applications from it.",
            },
          ].map((option) => {
