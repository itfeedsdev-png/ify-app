...
2. **Import your current resume**: Either upload a PDF/DOCX into ify app or choose the Reactive Resume option and connect with your v5 API key.
3. **Search terms**: ify app generates a first list of job-title search terms from your selected resume. Edit or regenerate them before saving.
...
ify app supports 2 PDF renderers:
